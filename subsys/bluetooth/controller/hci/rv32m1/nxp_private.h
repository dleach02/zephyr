 ...
 * -----------------------------------------------------------------------------
 *
 * Exported symbols/typdefs from the RV32M1 BLE Link Layer library
 *
 * -----------------------------------------------------------------------------
 */
...
/* RV32M1 BLE result type - the return value of BLE API functions */
typedef enum {
	/*
	 *
 ...
 *
 * The Link Layer controller library expects the link layer to operate in
