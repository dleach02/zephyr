...
#define MAIN_FLASH_FEATURE_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT FSL_FEATURE_FLASH_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT
#define MAIN_FLASH_FEATURE_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT FSL_FEATURE_FLASH_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT
...
#define SECONDARY_FLASH_FEATURE_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT FSL_FEATURE_FLASH_PFLASH_1_SECTOR_CMD_ADDRESS_ALIGMENT
#define SECONDARY_FLASH_FEATURE_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT FSL_FEATURE_FLASH_PFLASH_1_SECTION_CMD_ADDRESS_ALIGMENT
...
#define MAIN_FLASH_FEATURE_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT FSL_FEATURE_FLASH_PFLASH_1_SECTOR_CMD_ADDRESS_ALIGMENT
#define MAIN_FLASH_FEATURE_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT FSL_FEATURE_FLASH_PFLASH_1_SECTION_CMD_ADDRESS_ALIGMENT
...
#define SECONDARY_FLASH_FEATURE_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT FSL_FEATURE_FLASH_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT
 ...
 */
#if defined(__riscv)
/* Build with zero riscy core configuration. */
static const uint16_t s_flashRunCommandFunctionCode[] = {
      0x0793, 0xf800,    /* li  a5,-128 */
      0x0023, 0x00f5,    /*  sb  a5,0(a0) */
      0x4783, 0x0005,    /* lbu a5,0(a0) */
      0x07e2,            /* slli    a5,a5,0x18 */
      0x87e1,            /* srai    a5,a5,0x18 */
      0xdce3, 0xfe07,    /* bgez    a5, <flash_run_command+0x8> */
      0x8082             /* ret */
};
#else
static const uint16_t s_flashRunCommandFunctionCode[] = {
...
static const uint16_t s_flashCommonBitOperationFunctionCode[] = {
    0xc981,                    /* beqz    a1, <flash_common_bit_operation+0x10> */
    0x411c,                    /* lw  a5,0(a0) */
    0x96b3, 0x00c6,            /* sll a3,a3,a2 */
    0x8ebd,                    /* xor a3,a3,a5 */
    0x8df5,                    /* and a1,a1,a3 */
    0x8dbd,                    /* xor a1,a1,a5 */
    0xc10c,                    /* sw  a1,0(a0) */
                                                 ...
                                                 flash_operation_config_t *info)
{
...
#endif /* FLASH_SSD_IS_FLEXNVM_ENABLED */
    {
        ...
        if (config->FlashMemoryIndex == (uint8_t)kFLASH_MemoryIndexSecondaryFlash)
        {
            ...
            info->sectorCmdAddressAligment = SECONDARY_FLASH_FEATURE_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT;
            info->sectionCmdAddressAligment = SECONDARY_FLASH_FEATURE_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT;
        }
        else
#endif /* FLASH_SSD_IS_SECONDARY_FLASH_ENABLED */
        {
            info->blockWriteUnitSize = MAIN_FLASH_FEATURE_PFLASH_BLOCK_WRITE_UNIT_SIZE;
            info->sectorCmdAddressAligment = MAIN_FLASH_FEATURE_PFLASH_SECTOR_CMD_ADDRESS_ALIGMENT;
            info->sectionCmdAddressAligment = MAIN_FLASH_FEATURE_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT;
        }
