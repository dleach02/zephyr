...
def write_source_file(fp, vt, swt, intlist, syms):
    ...
    if "CONFIG_2ND_LVL_ISR_TBL_OFFSET" in syms:
        level2_offset = syms["CONFIG_2ND_LVL_ISR_TBL_OFFSET"]
    else:
        level2_offset = None

    if "CONFIG_3RD_LVL_ISR_TBL_OFFSET" in syms:
        level3_offset = syms["CONFIG_3RD_LVL_ISR_TBL_OFFSET"]
    else:
        level3_offset = None
